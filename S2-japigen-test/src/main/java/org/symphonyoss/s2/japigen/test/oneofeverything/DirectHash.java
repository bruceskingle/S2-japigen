...
/**
 * Example of a class which can be used as a direct external type with japigen.
 * 
...
public class DirectHash
{
  ...
  /*
   * The following japigen standard factory methods have been added so that this class
