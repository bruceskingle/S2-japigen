...
package org.symphonyoss.s2.japigen.test.persistence;

import java.io.IOException;

import com.symphony.s2.japigen.runtime.AbstractServer;
import com.symphony.s2.japigen.runtime.IModelRegistry;
import com.symphony.s2.japigen.test.unit.facade.Presence;
import com.symphony.s2.japigen.test.unit.facade.UsersHandler;
import com.symphony.s2.japigen.test.unit.facade.UsersUpdateHandler;
import com.symphony.s2.japigen.test.unit.facade.UsersUserIdHandler;
...
public class PresenceServer extends AbstractServer
{
  ...
  public void registerModels(IModelRegistry registry)
  {
    ...
    registry.register(new UsersUserIdHandler());
    registry.register(new UsersUpdateHandler());
  }
