...
public class Parameter extends ModelElement
{
  ...
  private Parameter(ModelElement parent, ParserContext parserContext, ParameterLocation location)
  {
    super(parent, parserContext, "Parameter");
  ...
  public @Nullable static Parameter create(ModelElement methodSchema, ParserContext paramContext)
  {
    ...
    return new Parameter(methodSchema, paramContext, parameterIn);
  }
